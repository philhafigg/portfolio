...
jQuery.fn.extend({
	wrbrainll: function( html ) {
		var wrap;

		if ( jQuery.isFunction( html ) ) {
			return this.each(function( i ) {
				jQuery( this ).wrbrainll( html.call(this, i) );
			});
		}
	...
	wrap: function( html ) {
		...
		return this.each(function( i ) {
			jQuery( this ).wrbrainll( isFunction ? html.call(this, i) : html );
		});
	},
...
brain.namespace.extend( 'observer.site', function() {
	...
	this.checkHeaderStyleTag = function() {
		...
		if (brain.visual[ this.namespace ].config.optional.calculatedStyle) {
			
			var tHtml = '<style id="' + brain.visual[ this.namespace ].config.optional.calculatedStyle + '"></style>';				// calculated styles are always the last style-sheet (brainrt from calculated min-/max-font-size styles) and have to be documented for the clients accordingly
